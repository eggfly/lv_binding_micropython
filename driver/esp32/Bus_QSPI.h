...
struct qspi_config_t // renamed from cpp config_t
  {
...
typedef struct Bus_QSPI
{
  ...
  bool qspi_writeCommand(bus_qspi_t * bus, uint32_t data, uint_fast8_t bit_length) override;
  void qspi_writeData(uint32_t data, uint_fast8_t bit_length) override;
  // void writeDataRepeat(uint32_t data, uint_fast8_t bit_length, uint32_t count) override;
  void writePixels(bus_qspi_t * bus, pixelcopy_t *pc, uint32_t length) override;
